...
pruning, the neighbours of the signal as well as the weights assigned to those neighbours needs to be specified.
  \begin{algorithm}
...
%   \begin{figure}[H]
% 	\begin{center}
% 	\includegraphics[width=\textwidth, height=3in]{data.eps}
...
% \begin{figure}[H]
% 	\begin{center}
% 	\includegraphics[width=\textwidth, height=3in]{error_cosamp.eps}
...
% \begin{figure}[H]
% 	\begin{center}
% 	\includegraphics[width=\textwidth, height=3in]{error_DGS.eps}
